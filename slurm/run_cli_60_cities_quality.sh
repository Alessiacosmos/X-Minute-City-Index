...
uv run xmin_core/cli.py --aoi_descriptor resources/explored_cities.gpkg --aoi_id_col URAU_CODE --config_descriptor configs/default_w_attr_completeness.yaml --output_dir $MY_WORKSPACE --activated_funcs=['quality'] --quality_indicators=['attribute_completeness']